...
import floppy from '../../content/thumbnails/bash.png'
        ...
        <div className="nav-container">
          <div className="brand">
            <Link to="/">
              ...
              <span className="text">Hack all the things</span>
            </Link>
          </div>
          <div className="links">
            {menuLinks.map(link => (
            ...
            <a target="_blank" rel="noopener noreferrer" href="https://ko-fi.com/dubs3c">
