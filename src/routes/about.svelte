...
<div class="article-header">
  <div class="container">
    <h1>Who dis?</h1>
    <p class="subtitle">Hacker, Developer and usually up to no good...</p>
  </div>
</div>
<main>
  <br />
  ...
  <ul>
    <li>Email: michael [at] dubell [dot] io</li>
    <li>GitHub: <a href="https://github.com/dubs3c">dubs3c</a></li>
    <li>Twitter: <a href="https://twitter.com/dubs3c">dubs3c</a></li>
  </ul>
  
  <h3>Get in touch!</h3>
  <p>If you have anything you want to share or just want to drop a message don't hesitate to send me an email or leave a comment.</p>
